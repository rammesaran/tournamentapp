...
import 'package:tournamentapp/application/auth/auth_bloc.dart' as _i9;
...
import 'package:tournamentapp/domain/home/i_home_repository.dart' as _i7;
...
import 'package:tournamentapp/infrastructure/home/home_repository.dart' as _i8;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i9.AuthBloc>(() => _i9.AuthBloc(gh<_i5.IAuthRepository>()));
    gh.factory<_i10.GetplayerBloc>(
        () => _i10.GetplayerBloc(gh<_i7.IHomeRepository>()));
    return this;
  }
}
